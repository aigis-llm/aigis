...
grant all privileges on all tables in schema "vector_stores" to authenticated, service_role;
grant all privileges on all routines in schema "vector_stores" to authenticated, service_role;
grant all privileges on all sequences in schema "vector_stores" to authenticated, service_role;
alter default privileges for role postgres in schema "vector_stores" grant all on tables to authenticated, service_role;
alter default privileges for role postgres in schema "vector_stores" grant all on routines to authenticated, service_role;
alter default privileges for role postgres in schema "vector_stores" grant all on sequences to authenticated, service_role;
